document.addEventListener('alpine:init', () => {
    Alpine.data('products', () => ({
        group1: [
            ...
            { id: 8, name: 'Set 3-in-1 Katun/Tencel', img: 'sh.png', price: 1380, basePrice: 1380, description: '➢ Sarung Bantal<br>➢ Seprai Fitted<br> ➢ Selimut Tipis Multifungsi<br><br>Bonus Pembelian ezCozy Item:<br>➢Pembelian $3900 atau lebih, Gratis 1pc Laundry Bag untuk perlengkapan tidur<br>➢Pembelian $6900 atau lebih, Gratis 1pc Selimut Dingin & Lembut' },
            { id: 9, name: 'Set 4-in-1 Katun/Tencel', img: 'sz.png', price: 1580, basePrice: 1580, description: '➢ Sarung Bantal<br>➢ Sarung Bantal<br>➢ Seprai Fitted<br> ➢ Selimut Tipis Multifungsi<br><br>Bonus Pembelian ezCozy Item:<br>➢Pembelian $3900 atau lebih, Gratis 1pc Laundry Bag untuk perlengkapan tidur<br>➢Pembelian $6900 atau lebih, Gratis 1pc Selimut Dingin & Lembut' },
            { id: 10, name: 'Paket Sarung Bantal + Seprai Katun/Tencel', img: 'st.png', price: 580, basePrice: 580, description: '➢ Sarung Bantal<br>➢ Sarung Bantal<br>➢ Seprai Fitted<br><br>Bonus Pembelian ezCozy Item:<br>➢Pembelian $3900 atau lebih, Gratis 1pc Laundry Bag untuk perlengkapan tidur<br>➢Pembelian $6900 atau lebih, Gratis 1pc Selimut Dingin & Lembut' },
